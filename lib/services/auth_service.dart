...
import 'package:coincollect/screens/auth/phone_otp.dart';
...
class Auth {
  ...
  Future<void> verifyPhoneNumber(BuildContext context, number) async {
    colorfulLoadingDialog(context, 'Please wait');
    ...
    final PhoneVerificationFailed verificationFailed =
      ...
      if (e.code == 'invalid-phone-number') {
        ...
        Navigator.pop(context);
        elegantAlertDialog(e.code, context);
      }
    };
  ...
  Future<void> signInwithPhoneNumber(
    ...
    try {
      ...
      if (userCredential != null) {
        ...
        elegantAlertDialog('Login Failed, Please retry again.', context);
      }
    } catch (e) {
      Navigator.pop(context);
      elegantAlertDialog(
  ...
  Future<DocumentSnapshot> getAdminCredentialEmailAndPassword(
    ...
    try {
      ...
      vibrantSnackBar(context: context, content: e.toString());
    }
    return result;
  }
  ...
  signInWithEmail(BuildContext context, String email, String password) async {
    try {
      colorfulLoadingDialog(context, 'Validating details');
  ...
  void registerWithEmail(BuildContext context, String email, String password,
    ...
    try {
      ...
      return users.doc(credential.user!.uid).set({
        ...
        vibrantSnackBar(context: context, content: 'Registered successfully');
      }).catchError((onError) {
        if (kDebugMode) {
          print(onError);
        }
