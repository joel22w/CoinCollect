              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: Text(
                      'RM ${categoryProvider.formData['price']}',
                      style: TextStyle(
                        color: blackColour,
                        fontWeight: FontWeight.bold,
                      ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          colorfulLoadingDialog(context, 'uploading to database..');
                          await updateUserProductData(
                                  categoryProvider,
                                  {
                                    'contact_details': {
                                      'mobile':
                                          '+60${_phoneNumberController.text}',
                        ...
                        child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              border: OutlineInputBorder(
                                  ...
                                  borderSide: BorderSide(color: blackColour)),
                            )),
                      )
                    ],
                  ),
